...
export default function SNSButton({ type, onClick, hasLabel = false, className }: SNSButtonProps) {
  if (type === "naver") {
    return (
      <Button
        variant="outline"
  ...
  if (type === "kakao") {
    return (
      ...
      >
        ...
        {hasLabel && <span>카카오톡으로 시작하기</span>}
      </Button>
    );
  }
  ...
  if (type === "google") {
    return (
      <Button variant="outline" type="button" className="w-full bg-gray-50" aria-label="Google로 로그인">
        <img
