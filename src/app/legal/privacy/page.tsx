        ...
        <div className="space-y-8">
          ...
          <article className="rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-sm">
            <div className="space-y-6 text-sm leading-7 text-slate-600">
              ...
              <section>
                <h2 className="text-lg font-semibold text-slate-950">{t("legal.privacy.s1.title")}</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-slate-950">{t("legal.privacy.s2.title")}</h2>
                <p className="mt-2">{t("legal.privacy.s2.body")}</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-slate-950">{t("legal.privacy.s3.title")}</h2>
                <p className="mt-2">{t("legal.privacy.s3.body")}</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-slate-950">{t("legal.privacy.s4.title")}</h2>
                <p className="mt-2">
                  {t("legal.privacy.s4.body")}{" "}
                  <a className="font-medium text-[color:var(--link-accent)] underline" href="mailto:privacy@roboshop.co.kr">
                    privacy@roboshop.co.kr
                  </a>
                </p>
              </section>
            </div>
